...
import { CheckCircle, Users, BookOpen, TrendingUp, Award, Video, Play } from "lucide-react";
...
const Index = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "لضمان الجودة يمكن طلب استرداد المبلغ أول ٧ أيام من بدء البرنامج بحال عدم الرضا"
    }
  ];
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="text-lg text-[#333333] leading-relaxed space-y-4">
              <p>كم مرة شعرت أن الاستثمار في الأسهم أمر معقد، محفوف بالمخاطر، ومخصص فقط لـ "الخبراء"؟</p>
      ...
      <section className="bg-[#1A237E] py-16 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-white mt-6 opacity-90">
            البرنامج الذي لا يُعلّمك فقط كيف تستثمر… بل يغيّر طريقتك في التفكير بالمال بالكامل.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <CardContent>
                  <p className="text-[#333333] text-center">{benefit.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div className="space-y-4 text-lg text-[#333333] leading-relaxed">
              ...
              <p>أنا أشاركك خلاصة سنوات من التجربة، الخسارات، الأرباح، والنجاحات…</p>
              <p className="font-bold text-[#2C3E50]">هذا ليس برنامجاً نظرياً.</p>
              <p>بل نظام عملي متكامل مبني على استراتيجيات استثمار عالمية – مثل التي يتبعها وارن بافت وجاك بوجل – ومطوّع ليناسب واقعنا.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="bg-[#F7F7F7] p-6 rounded-lg border-r-4 border-[#27AE60]">
                <p className="text-lg text-[#333333] leading-relaxed mb-4">
                  كنت شابة طموحة لدي عقبات مالية وأحلام كبيرة اعتبرها شبه مستحيلة..
                </p>
                <p className="text-lg text-[#333333] leading-relaxed mb-4">
                  لكن حين فهمت قواعد المال… تغير كل شيء.
                </p>
                <p className="text-lg text-[#333333] leading-relaxed mb-4">
                  اليوم، أمتلك أصولًا تدرّ عليّ دخلاً سلبياً، وأساعد مئات الأشخاص على الخروج من دوامة الديون إلى طريق الحرية المالية. أساعد أهلي وعائلتي وأقدم الإلهام لجميع من حولي ✨
                </p>
          ...
          <div className="bg-white p-8 rounded-lg shadow-2xl">
            ...
            <div className="space-y-6">
              <div className="text-2xl text-[#333333]">
                ...
                <span className="text-4xl font-bold text-[#27AE60] mx-2">888 دولار</span>
              </div>
                ...
                <CardContent className="p-6">
                  <div className="aspect-video bg-gray-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-gray-50 transition-colors">
                    <div className="text-center text-gray-500">
                      ...
                      <p className="text-sm">فيديو رأي العميل #{index}</p>
                    </div>
                  </div>
